...
import (
	"bytes"
	"github.com/jaycasa928/my-bookings/pkg/config"
	"github.com/jaycasa928/my-bookings/pkg/models"
	"html/template"
	"log"
	"net/http"
	"path/filepath"
...
func RenderTemplate(w http.ResponseWriter, tmpl string, td *models.TemplateData) {
	...
	// create a var buffer that will hold bytes and try to execute the value from that map
